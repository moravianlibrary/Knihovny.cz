...
if command -v shellcheck &> /dev/null; then
    shellcheck bin/inc/*.sh bin/*.sh && echo "Shellcheck: OK"
else
    echo "WARNING: shellcheck is not installed. Please install it to enable shell script linting."
    echo "Installation guide: https://github.com/koalaman/shellcheck#installing"
fi
