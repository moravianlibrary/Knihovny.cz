...
$config = [
    ...
    'controllers' => [
        'factories' => [
            ...
            \KnihovnyCz\Controller\SummonController::class => \VuFind\Controller\AbstractBaseFactory::class,
        ],
        'aliases' => [
            ...
            \VuFind\Controller\SummonController::class => \KnihovnyCz\Controller\SummonController::class,
        ],
    ],
    'controller_plugins' => [
        'invokables' => [
        ...
        'plugin_managers' => [
            ...
            'ils_driver' => [
                'factories' => [
                    ...
                    \KnihovnyCz\ILS\Driver\XCNCIP2::class => \VuFind\ILS\Driver\XCNCIP2Factory::class,
                    ...
                    \KnihovnyCz\ILS\Driver\AlephNkp::class => \KnihovnyCz\ILS\Driver\AlephNkpFactory::class,
            ...
            'ajaxhandler' => [
                'factories' => [
                    ...
                    \VuFind\AjaxHandler\GetUserTransactions::class => \KnihovnyCz\AjaxHandler\AbstractIlsUserAndRendererActionFactory::class,
                    \VuFind\AjaxHandler\GetUserHolds::class => \KnihovnyCz\AjaxHandler\AbstractIlsUserAndRendererActionFactory::class,
                    \VuFind\AjaxHandler\GetUserFines::class => \KnihovnyCz\AjaxHandler\GetUserFinesFactory::class,
                    \VuFind\AjaxHandler\GetUserILLRequests::class => \VuFind\AjaxHandler\AbstractIlsUserAndRendererActionFactory::class,
            ...
            'navigation' => [
                'factories' => [
                    \KnihovnyCz\Navigation\AccountMenu::class => \KnihovnyCz\Navigation\AccountMenuFactory::class,
                ],
                'aliases' => [
                    \VuFind\Navigation\AccountMenu::class => \KnihovnyCz\Navigation\AccountMenu::class,
                ],
            ],
        ],
    ],
    'service_manager' => [
        'factories' => [
            ...
            \KnihovnyCz\Service\TranslationService::class => \Laminas\ServiceManager\Factory\InvokableFactory::class,
            ...
            \KnihovnyCz\Service\PreferredInstitutionsService::class                            => \KnihovnyCz\Service\PreferredInstitutionsServiceFactory::class,
